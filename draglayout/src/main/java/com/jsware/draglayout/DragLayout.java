...
public class DragLayout extends FrameLayout {
    ...
    private int menuResId = 0,contentResId = 0;
    private View vg_left;
    private DragContentLayout vg_main;
    ...
    public DragLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        menuResId = a.getResourceId(R.styleable.DragLayout_leftMenu, 0);
        contentResId = a.getResourceId(R.styleable.DragLayout_bodyContent, 0);
        a.recycle();
    }
    ...
    public void setDragListener(DragCallBack dragListener) {
    ...
    protected void onFinishInflate() {
        ...
        if (contentResId != 0) {
            vg_main = (DragContentLayout) findViewById(contentResId);
            vg_main.setDragLayout(this);
            vg_main.setClickable(true);
        }
        if (menuResId != 0) {
            vg_left = findViewById(menuResId);
            vg_left.setClickable(true);
        }
//        vg_left = getChildAt(0);
//        vg_main = (DragContentLayout) getChildAt(isShowShadow ? 2 : 1);
    }
